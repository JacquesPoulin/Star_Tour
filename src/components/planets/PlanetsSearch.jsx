  ...
  return (
    <div className="flex flex-col items-start justify-start p-8 bp2:mt-20 bp4:p-4">
      ...
      <input
        ...
        className="w-[400px] text-2xl bg-slate-50  bg-opacity-[10%] bg-[url(assets/images/loupe.png)] bg-contain bg-no-repeat pl-12 text-slate-50 dark:text-slate-900 font-exo p-1 mt-2 rounded-lg border-2 border-slate-50 dark:border-slate-900 box-shadow-1 bp4:w-[300px]"
      />
      <Link to="/quiz">
        <button
          type="button"
