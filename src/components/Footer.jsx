...
const Footer = () => {
  return (
    <footer className="w-full px-4 py-6 bg-slate-900">
      ...
      <div className="flex flex-col flex-wrap w-full md:pb-px20">
        {/* Icons */}
        <div className="flex flex-row flex-wrap w-full md:pb-px20">
          <div className="flex flex-wrap justify-between w-2/3 px-1 py-5">
            ...
            <a href="tel:0607514408">
              <p className="flex px-1 py-1 text-xs font-bold text-slate-50">
                <svg
  ...
  0s202 90.6 202 202c0 78.2-32.9 150.9-92.7 204.6-53.3 47.8-124.4 76.3-190.4 76.3zM298 22.2c-99.1
   0-179.8 80.6-179.8 179.8 0 81.2 54.7 152.6 133 173.6.6.2 1.2.4 1.7.6 22.1 10.1 23.9 39.8 23.9 48.6
    ...
    0c0 12-9.7 21.7-21.7 21.7s-21.7-9.7-21.7-21.7 9.7-21.7 21.7-21.7 21.7 9.7 21.7 21.7z"
            ...
            {/* Adress */}
            <a href="#">
              <p className="flex px-3 py-1 text-xs font-bold text-slate-50">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex flex-wrap justify-end w-1/3 px-1 py-5">
            ...
            {/* GitHub */}
            <a href="https://github.com/" className="ml-3 text-slate-50">
        ...
        {/* :CGV/NEWSLETTER */}
        <div>
          <nav className="flex flex-wrap justify-center px-2 py-4 text-lg list-none text-slate-50">
            <li className="p-3 hover:font-semibold">
              <button
                className="block w-full md:w-auto text-white bg-transparent hover:bg-slate-50 hover:text-slate-900 focus:ring-1 focus:outline-none focus:ring-slate-50 font-medium rounded-lg text-lg px-5 py-2.5 text-center"
                type="button"
